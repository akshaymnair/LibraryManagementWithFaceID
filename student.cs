    ...
    public partial class student : Form
    {
        ...
        public student()
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Student database empty, please add students!!", "Triained faces load", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
